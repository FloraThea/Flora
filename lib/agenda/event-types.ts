...
export const AGENDA_EVENT_TYPES: EventTypeDefinition[] = [
  ...
  { type: "reunion", label: "Réunion", category: "administratif", color: "peach", icon: "users", auto108hCategory: "108_conseils_maitres", defaultDurationMinutes: 90 },
  ...
  { type: "prep_apc", label: "Préparation APC / besoins élèves", category: "108h", color: "cream", icon: "puzzle", auto108hCategory: "108_prep_apc", defaultDurationMinutes: 120 },
  { type: "rdv_parents", label: "Rendez-vous parents", category: "pedagogique", color: "rose", icon: "heart", auto108hCategory: "108_conseils_maitres", defaultDurationMinutes: 30 },
  { type: "ess", label: "ESS", category: "108h", color: "peach", icon: "leaf", auto108hCategory: "108_animations", defaultDurationMinutes: 120 },
  { type: "equipe_educative", label: "Équipe éducative", category: "108h", color: "lavender", icon: "team", auto108hCategory: "108_conseils_maitres", defaultDurationMinutes: 90 },
