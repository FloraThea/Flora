...
const MODULE_EXTENSION_SETS: Record<ImportModule, readonly string[]> = {
  ...
  progression: [".xlsx", ".xls", ".pdf", ".docx", ...SUPPORTED_IMAGE_EXTENSIONS],
  sequence: [".xlsx", ".xls", ".csv", ".pdf", ".docx", ...SUPPORTED_IMAGE_EXTENSIONS],
  seance: [".xlsx", ".xls", ".csv", ".pdf", ".docx", ...SUPPORTED_IMAGE_EXTENSIONS],
...
const MODULE_HELP_LABELS: Record<ImportModule, string> = {
  ...
  progression: "JPG, JPEG, PNG, PDF, DOCX et Excel (.xlsx, .xls)",
  sequence: "JPG, JPEG, PNG, PDF, DOCX, Excel (.xlsx, .xls) et CSV",
  seance: "JPG, JPEG, PNG, PDF, DOCX, Excel (.xlsx, .xls) et CSV",
