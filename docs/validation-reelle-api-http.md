...
- Compte test : `flora-api-real-1784423805687@test.flora.local`
- Date : 2026-07-19T01:18:24.922Z
...
|--------|-------|---------|------------|-------|---------|-------------|
| programmation | API — Programmation HDA 1784423807167 | 35 | 35 | ✓ | ✓ | ✓ |
| progression | API — Progression EMC 1784423812371 | 34 | 34 | ✓ | ✓ | ✓ |
| emploi_du_temps | API — EDT rentrée 1784423815507 | 56 | 56 | ✓ | ✓ | ✓ |
